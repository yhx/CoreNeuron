...
option(AUTO_TEST_WITH_MPIEXEC
       "automatically add mpiexec as test prefix in a MPICH2/OpenMPI environment" TRUE)

#
# Basic SLURM support the prefix "srun" is added to any test in the environment For a slurm test
# execution, simply run "salloc [your_exec_parameters] ctest"
#
...
#
# MPI executor program path without arguments used for testing. default: srun or mpiexec if found
#
...
#
# Test execution prefix. Override this variable for any execution prefix required in clustered
# environment
#
# To specify manually a command with argument, e.g -DTEST_EXEC_PREFIX="/usr/bin/srun;-n;-4" for a
# srun execution with 4 nodes
#
