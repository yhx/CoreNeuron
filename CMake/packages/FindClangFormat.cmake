...
foreach(p ${_PATH})
  ...
  foreach(candidate ${cand})
    ...
    if((${CLANG_FORMAT_VERSION} VERSION_GREATER ${CLANG_FORMAT_MIN_VERSION})
       OR (${CLANG_FORMAT_VERSION} VERSION_EQUAL ${CLANG_FORMAT_MIN_VERSION}))
      set(FIT_MIN_REQUIRED true)
    else()
      set(FIT_MIN_REQUIRED false)
    endif()
    if((${CLANG_FORMAT_VERSION} VERSION_LESS ${CLANG_FORMAT_MAX_VERSION})
       OR (${CLANG_FORMAT_VERSION} VERSION_EQUAL ${CLANG_FORMAT_MAX_VERSION}))
